...
export type GetSubAlbumQuery = { getAlbum: { album: Maybe<Pick<Album, 'name'>>, albums: Array<Pick<Album, 'name' | 'source' | 'dir' | 'preview' | 'nbAlbums' | 'nbPhotos'>> } };
...
export type GetPhotosQuery = { getSearch: { photos: Array<Maybe<Pick<SearchPhoto, 'id' | 'thumbnails' | 'file'>>> } };
...
export type GetFiltersQuery = { getFilters: (
    Pick<GetFilters, 'cameraMakes' | 'cameraModels'>
...
export type GetSourcesQuery = { getSources: Array<Maybe<Pick<Source, 'name' | 'nbAlbums' | 'nbPhotos' | 'preview'>>> };
...
export type GetPhotoQuery = { getPhoto: Maybe<(
    Pick<PhotoDetail, 'aperture' | 'birthtime' | 'iso' | 'make' | 'model' | 'shutter' | 'files' | 'next' | 'previous'>
...
export type AuthEmailMutation = { authEmail: Pick<AuthEmailType, 'messageId' | 'messageData'> };
...
export type GetTreeQuery = { getTree: { sources: Array<Pick<GetTreeSources, 'name'>>, albums: Array<Pick<GetTreeAlbums, 'dir' | 'parentDir' | 'source'>> } };

export type GetCurrentUserQueryVariables = {};


export type GetCurrentUserQuery = { getCurrentUser: Maybe<Pick<CurrentUserType, 'name' | 'email'>> };
